  ...
  return (
    <Layout title="Register - Ecommer App">
      <div
        ...
        style={{ minHeight: "90vh", padding: "80px", background: "white" }}
      >
        <form
        ...
        >
          ...
          <div className="mb-4 px-2">
            <label className="mb-2 text-muli text-heading">Your Name</label>
            <input
              type="text"
              value={name}
          ...
          <div className="mb-4 px-2">
            <label className="mb-2 text-muli text-heading">Your phone</label>
            <input
              type="text"
              value={phone}
          ...
          <div className="mb-4 px-2">
            <label className="mb-2 text-muli text-heading">Your Address</label>
            <input
              type="text"
              value={address}
